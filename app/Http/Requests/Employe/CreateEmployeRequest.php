...
class CreateEmployeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'numero_compte_bancaire' => ['nullable', 'string','unique:employes,email'],
            ...
            'numero_identification_employe' => ['string', 'unique:employes,numero_identification_employe'],
    ...
    public function messages(): array
{
    return [
        ...
        'telephone.regex' => 'Le numéro de téléphone doit être au format +221 suivi de 7 chiffres pour les opérateurs valides (77, 78, 76, 70, 75, 33).',
        ...
        'numero_identification_employe.unique' => 'Le numéro_identification_employe est déjà utilisé.',
    ];
}
