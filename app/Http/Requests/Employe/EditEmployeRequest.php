...
class EditEmployeRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'statut_emploie.required' => 'Le statut de l\'emploi est obligatoire.',
            'statut_emploie.in' => 'Le statut de l\'emploi doit être permanent, vacataire, contractuel ou honoraire.',
